...
GLuint texture::settextureinner()
{
    ...
    unsigned char* data = stbi_load("images/fot.png", &width, &height, &numChannels, 0);
...
GLuint texture::settextureouter()
{
    ...
    // Replace this with your own texture loading code using stb_image.h
    int width, height, numChannels;
    unsigned char* data = stbi_load("images/Attitude_Director_Indicator.png", &width, &height, &numChannels, 0);
